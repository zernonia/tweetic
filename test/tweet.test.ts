...
describe("server api", () => {
  it("should return tweets html & oembed", async () => {
    expect(
      await $fetch("/api/tweet", {
        params: { url: "https://twitter.com/zernonia/status/1524620865987506176", layout: "supabase", css: "tailwind" },
      })
    ).toMatchObject(compareObject)
  })
})
